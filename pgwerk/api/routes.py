...
class JobController(Controller):
    ...
    async def create_job(self, werk: Wrk, data: EnqueueRequest) -> JobResponse:
        """Enqueue a new job.
    ...
    @get("/{job_id:str}")
    async def get_job(self, werk: Wrk, job_id: str) -> JobResponse:
    ...
    async def get_job_executions(self, werk: Wrk, job_id: str) -> list[ExecutionResponse]:
    ...
    async def get_job_dependencies(self, werk: Wrk, job_id: str) -> list[str]:
    ...
    async def cancel_job(self, werk: Wrk, job_id: str) -> dict[str, Any]:
    ...
    async def abort_job(self, werk: Wrk, job_id: str) -> dict[str, Any]:
    ...
    async def requeue_job(self, werk: Wrk, job_id: str) -> dict[str, Any]:
    ...
    async def delete_job(self, werk: Wrk, job_id: str) -> None:
    ...
    @post("/requeue")
    async def requeue_jobs(self, werk: Wrk, data: BulkRequeueRequest) -> dict[str, Any]:
    ...
    @post("/cancel")
    async def cancel_jobs(self, werk: Wrk, data: BulkCancelRequest) -> dict[str, Any]:
    ...
    @post("/purge")
    async def purge_jobs(self, werk: Wrk, data: PurgeRequest) -> dict[str, Any]:
...
class WorkerController(Controller):
    ...
    @get("")
    async def list_workers(self, werk: Wrk) -> list[WorkerResponse]:
    ...
    @get("/{worker_id:str}")
    async def get_worker(self, werk: Wrk, worker_id: str) -> WorkerResponse:
...
class StatsController(Controller):
    ...
    @get("")
    async def get_stats(self, werk: Wrk) -> StatsResponse:
...
class CronController(Controller):
    ...
    @get("")
    async def list_cron_jobs(self, werk: Wrk) -> list[CronJobStats]:
    ...
    async def trigger_cron_job(self, werk: Wrk, name: str) -> JobResponse:
...
class ServerController(Controller):
    ...
    @get("")
    async def get_server_info(self, werk: Wrk) -> ServerInfo:
    ...
    @post("/sweep")
    async def run_sweep(self, werk: Wrk) -> dict[str, Any]:
    ...
    async def reschedule_stuck(self, werk: Wrk) -> dict[str, Any]:
    ...
    @post("/vacuum")
    async def vacuum_tables(self, werk: Wrk) -> dict[str, Any]:
    ...
    @post("/truncate")
    async def truncate_tables(self, werk: Wrk) -> dict[str, Any]:
